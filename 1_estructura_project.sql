...
ADD CONSTRAINT fk_tasacion_vehiculo FOREIGN KEY (id_vehiculo) REFERENCES VEHICULO (id_vehiculo);

ALTER TABLE TRANSACCION
ADD CONSTRAINT fk_trans_cliente FOREIGN KEY (id_cliente) REFERENCES CLIENTE (id_cliente);

ALTER TABLE TRANSACCION
ADD CONSTRAINT fk_trans_vehiculo FOREIGN KEY (id_vehiculo) REFERENCES VEHICULO (id_vehiculo);

ALTER TABLE TALLER_VEHICULO
ADD CONSTRAINT fk_taller_vehiculo FOREIGN KEY (id_vehiculo) REFERENCES VEHICULO (id_vehiculo);

ALTER TABLE TALLER_VEHICULO
ADD CONSTRAINT fk_taller_taller FOREIGN KEY (id_taller) REFERENCES TALLER (id_taller);

-- TABLES DE OBJETOS
CREATE TABLE
    riesgo_vehiculo_taller (
